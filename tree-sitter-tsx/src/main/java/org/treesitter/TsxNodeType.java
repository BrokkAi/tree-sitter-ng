...
/**
 * Node types for {@code tsx} from tree-sitter {@code node-types.json}.
 */
public enum TsxNodeType {
    ...
    public static final Set<TsxNodeType> DECLARATION_SET = Set.of(
    ...
    public static final Set<TsxNodeType> EXPRESSION_SET = Set.of(
            ...
            UPDATE_EXPRESSION,
            YIELD_EXPRESSION);
    public static final Set<TsxNodeType> PATTERN_SET = Set.of(
            ARRAY_PATTERN,
            IDENTIFIER,
            MEMBER_EXPRESSION,
            NON_NULL_EXPRESSION,
            ...
            UNDEFINED);
    public static final Set<TsxNodeType> PRIMARY_EXPRESSION_SET = Set.of(
            ARRAY,
            ARROW_FUNCTION,
            CALL_EXPRESSION,
            CLASS_,
            ...
            TRUE,
            UNDEFINED);
    public static final Set<TsxNodeType> PRIMARY_TYPE_SET = Set.of(
            ARRAY_TYPE,
            CONDITIONAL_TYPE,
            EXISTENTIAL_TYPE,
            FLOW_MAYBE_TYPE,
            ...
            TYPE_QUERY,
            UNION_TYPE);
    public static final Set<TsxNodeType> STATEMENT_SET = Set.of(
            BREAK_STATEMENT,
            CONTINUE_STATEMENT,
            DEBUGGER_STATEMENT,
            DECLARATION,
            ...
            WHILE_STATEMENT,
            WITH_STATEMENT);
    public static final Set<TsxNodeType> TYPE_SET = Set.of(
            CALL_EXPRESSION,
            CONSTRUCTOR_TYPE,
            FUNCTION_TYPE,
            INFER_TYPE,
    ...
    TsxNodeType(@Nullable String type) {
        this.type = type;
    }
    ...
    public static TsxNodeType from(@Nullable TSNode node) {
        if (node == null) return __NULL__;
        return fromType(node.getType());
    }

    public static TsxNodeType fromType(@Nullable String type) {
        if (type == null) return __NULL__;
        TsxNodeType t = LOOKUP.get(type);
        return t == null ? __NULL__ : t;
    }

    private static final Map<String, TsxNodeType> LOOKUP = initLookup();

    private static Map<String, TsxNodeType> initLookup() {
        HashMap<String, TsxNodeType> m = new HashMap<>();
        for (TsxNodeType t : values()) {
